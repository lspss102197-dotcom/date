...
def test_trip_full_lifecycle(tmp_path):
    ...
    points = [
        ...
        {"latitude": 25.0416, "longitude": 121.5438, "speed": 2.0, "recorded_at": (started_time + datetime.timedelta(seconds=600)).isoformat()},
        {"latitude": 25.0413, "longitude": 121.5478, "speed": 1.8, "recorded_at": (started_time + datetime.timedelta(seconds=1200)).isoformat()}
    ]
    ...
    ended_time = started_time + datetime.timedelta(seconds=1800) # 30分鐘
    ...
    assert res_data["duration_seconds"] == 1800
